...
const BlockedPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    console.log('💬 BlockedPage: Mensagem motivacional selecionada:', randomMessage)
  }, [])
      ...
      <div className="max-w-2xl mx-auto text-center p-8">
        <div className="mb-8">
          <div className="w-24 h-24 bg-warning-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <Shield className="w-12 h-12 text-warning-600" />
          </div>
        ...
        {state.currentTask && (
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 mb-8 border border-white/20 shadow-lg">
            <div className="flex items-center justify-center mb-4">
              ...
              <span className="text-lg font-semibold text-slate-800">Seu foco atual:</span>
            </div>
            ...
            {state.isActive && (
              <div className="flex items-center justify-center">
                ...
                <span className="text-lg text-slate-700">
                  Tempo restante: <span className="font-mono font-bold text-focus-600">
